# 🛠️ Extension Fixer Legacy — Tkinter 1.0.3

> This archived version is preserved for users who need the standard-library
> Tkinter interface. Extension Fixer 2.0 in the repository root is the current
> application.
...
├── operation_log.json  # created at runtime after repairs
└── README.md
```
