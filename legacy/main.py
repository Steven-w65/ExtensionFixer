...
def get_application_dir():
    """Return the folder that owns mutable settings and recovery data."""
...
class ExtensionRepairApp:
    ...
    def __init__(self, root):
        ...
        self.settings_store = ApplicationSettings(app_dir / "settings.json")
        self.settings = self.settings_store.load()
        self._fit_window_to_screen()

        self.format_config_path = app_dir / "custom_magic_formats.json"
        self.detector = MagicNumberDetector(self.format_config_path)
        self.scanner = FileScanner(self.detector)
        self.operations = FileOperations(app_dir / "operation_log.json")
